...
namespace Bundle\OneToManyBundle\DependencyInjection;

use Bundle\OneToManyBundle\Doctrine\ORM\Driver as DoctrineORMDriver;
use Bundle\OneToManyBundle\SyliusOneToManyBundle;
...
final class Configuration implements ConfigurationInterface
{
    ...
    private function addDriversSection(ArrayNodeDefinition $node): void
    {
        $node
            ->children()
                ->arrayNode('drivers')
                    ->defaultValue([SyliusOneToManyBundle::DRIVER_DOCTRINE_ORM])
                    ->prototype('enum')->values(SyliusOneToManyBundle::getAvailableDrivers())->end()
                ->end()
            ->end()
        ;
    }
