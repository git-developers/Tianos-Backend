...
namespace Bundle\ClientBundle\Controller;

use FOS\RestBundle\View\View;
use Bundle\ClientBundle\Form\Type\ClientAttributeChoiceType;
...
class ClientAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(ClientAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
