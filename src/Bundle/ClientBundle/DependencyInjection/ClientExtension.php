...
use Bundle\ClientBundle\Controller\ProductAttributeController;
use Bundle\ClientBundle\Doctrine\ORM\ProductAttributeValueRepository;
use Bundle\ClientBundle\Form\Type\ProductAttributeTranslationType;
use Bundle\ClientBundle\Form\Type\ProductAttributeType;
use Bundle\ClientBundle\Form\Type\ProductAttributeValueType;
...
final class ClientExtension extends AbstractResourceExtension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
