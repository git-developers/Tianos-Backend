...
use Bundle\GroupofusersBundle\Form\Type\GroupofusersAttributeChoiceType;
...
class GroupofusersAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(GroupofusersAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
