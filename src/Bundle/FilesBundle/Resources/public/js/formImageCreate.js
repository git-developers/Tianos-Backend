(function($) {
    ...
    $.formImageCreate = function(el, options) {
        ...
        base.$el = $(el);
        base.el = el;
        base.$el.data('formImageCreate', base);
    ...
    // $.formImageCreate.defaultOptions = {
    //     buttonStyle: "border: 1px solid #fff; background-color:#000; color:#fff; padding:20px 50px",
    //     buttonPress: function () {}
    // };

    $.fn.formImageCreate = function(options){

        return this.each(function(){

            var bp = new $.formImageCreate(this, options);
