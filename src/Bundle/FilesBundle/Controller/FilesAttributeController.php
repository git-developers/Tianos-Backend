...
use Bundle\FilesBundle\Form\Type\FilesAttributeChoiceType;
...
class FilesAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(FilesAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
