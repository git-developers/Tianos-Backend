...
use Bundle\FilesBundle\Controller\ProductAttributeController;
use Bundle\FilesBundle\Doctrine\ORM\ProductAttributeValueRepository;
use Bundle\FilesBundle\Form\Type\ProductAttributeTranslationType;
use Bundle\FilesBundle\Form\Type\ProductAttributeType;
use Bundle\FilesBundle\Form\Type\ProductAttributeValueType;
...
final class FilesExtension extends AbstractResourceExtension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
