...
namespace Bundle\EscuelaBundle\Controller;

use FOS\RestBundle\View\View;
use Bundle\EscuelaBundle\Form\Type\EscuelaAttributeChoiceType;
...
class EscuelaAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(EscuelaAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
