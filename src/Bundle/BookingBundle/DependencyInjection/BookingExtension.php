...
namespace Bundle\BookingBundle\DependencyInjection;

use Bundle\BookingBundle\Controller\ProductAttributeController;
use Bundle\BookingBundle\Doctrine\ORM\ProductAttributeValueRepository;
use Bundle\BookingBundle\Form\Type\ProductAttributeTranslationType;
use Bundle\BookingBundle\Form\Type\ProductAttributeType;
use Bundle\BookingBundle\Form\Type\ProductAttributeValueType;
...
final class BookingExtension extends AbstractResourceExtension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
