...
use Bundle\BookingBundle\Form\Type\BookingAttributeChoiceType;
...
class BookingAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(BookingAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
