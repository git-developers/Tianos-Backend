...
namespace Bundle\DUMMY_UPPERBundle\Controller;

use FOS\RestBundle\View\View;
use Bundle\DUMMY_UPPERBundle\Form\Type\DUMMY_UPPERAttributeChoiceType;
...
class DUMMY_UPPERAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(DUMMY_UPPERAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
