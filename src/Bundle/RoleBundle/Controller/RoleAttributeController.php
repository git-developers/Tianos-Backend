...
namespace Bundle\RoleBundle\Controller;

use FOS\RestBundle\View\View;
use Bundle\RoleBundle\Form\Type\RoleAttributeChoiceType;
...
class RoleAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(RoleAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
