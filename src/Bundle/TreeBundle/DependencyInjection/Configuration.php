...
namespace Bundle\TreeBundle\DependencyInjection;

use Bundle\TreeBundle\Doctrine\ORM\Driver as DoctrineORMDriver;
use Bundle\TreeBundle\SyliusTreeBundle;
...
final class Configuration implements ConfigurationInterface
{
    ...
    private function addDriversSection(ArrayNodeDefinition $node): void
    {
        $node
            ->children()
                ->arrayNode('drivers')
                    ->defaultValue([SyliusTreeBundle::DRIVER_DOCTRINE_ORM])
                    ->prototype('enum')->values(SyliusTreeBundle::getAvailableDrivers())->end()
                ->end()
            ->end()
        ;
    }
