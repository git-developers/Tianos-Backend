...
use Bundle\CategoryBundle\Controller\ProductAttributeController;
use Bundle\CategoryBundle\Doctrine\ORM\ProductAttributeValueRepository;
use Bundle\CategoryBundle\Form\Type\ProductAttributeTranslationType;
use Bundle\CategoryBundle\Form\Type\ProductAttributeType;
use Bundle\CategoryBundle\Form\Type\ProductAttributeValueType;
...
final class CategoryExtension extends AbstractResourceExtension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
