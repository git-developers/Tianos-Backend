...
use Bundle\CategoryBundle\Form\Type\CategoryAttributeChoiceType;
...
class CategoryAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(CategoryAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
