...
namespace Bundle\ResourceBundle\Orderin\Renderer;

use Bundle\CoreBundle\Services\Button;
use Bundle\ResourceBundle\Orderin\Parser\OptionsParserInterface;
...
final class TwigOrderinRenderer implements OrderinRendererInterface
{
    /**
    ...
    public function __construct(
        OrderinRendererInterface $gridRenderer,
