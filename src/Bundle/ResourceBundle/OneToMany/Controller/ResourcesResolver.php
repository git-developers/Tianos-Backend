...
use Bundle\ResourceBundle\OneToMany\View\ResourceOneToManyViewFactoryInterface;
...
final class ResourcesResolver implements ResourcesResolverInterface
{
    ...
    /**
     * @var ResourceOneToManyViewFactoryInterface
     */
     ...
     * @param ResourceOneToManyViewFactoryInterface $gridViewFactory
     */
    public function __construct(
        ResourcesResolverInterface $decoratedResolver,
        OneToManyProviderInterface $gridProvider,
        ResourceOneToManyViewFactoryInterface $gridViewFactory
    ) {
