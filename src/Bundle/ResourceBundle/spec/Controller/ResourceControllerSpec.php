...
use Bundle\ResourceBundle\Controller\EventDispatcherInterface;
use Bundle\ResourceBundle\Controller\FlashHelperInterface;
use Bundle\ResourceBundle\Controller\NewResourceFactoryInterface;
use Bundle\ResourceBundle\Controller\RedirectHandlerInterface;
use Bundle\ResourceBundle\Controller\RequestConfiguration;
use Bundle\ResourceBundle\Controller\RequestConfigurationFactoryInterface;
use Bundle\ResourceBundle\Controller\ResourceDeleteHandlerInterface;
use Bundle\ResourceBundle\Controller\ResourceFormFactoryInterface;
use Bundle\ResourceBundle\Controller\ResourcesCollectionProviderInterface;
use Bundle\ResourceBundle\Controller\ResourceUpdateHandlerInterface;
use Bundle\ResourceBundle\Controller\SingleResourceProviderInterface;
...
final class ResourceControllerSpec extends ObjectBehavior
{
    ...
    function it_returns_a_response_for_html_view_of_a_single_resource(
        ...
        $configuration->getTemplate(ResourceActions::SHOW . '.html')->willReturn('SyliusShopBundle:CRUD_DUMMY:show.html.twig');
        ...
        $expectedView = View::create()
            ...
            ->setTemplate('SyliusShopBundle:CRUD_DUMMY:show.html.twig')
        ;
    ...
    function it_returns_a_response_for_html_view_of_paginated_resources(
        ...
        $configuration->isHtmlRequest()->willReturn(true);
        $configuration->getTemplate(ResourceActions::INDEX . '.html')->willReturn('SyliusShopBundle:CRUD_DUMMY:index.html.twig');
        ...
        $expectedView = View::create()
            ...
            ->setTemplate('SyliusShopBundle:CRUD_DUMMY:index.html.twig')
        ;
    ...
    function it_returns_a_html_response_for_creating_new_resource_form(
        ...
        $configuration->isHtmlRequest()->willReturn(true);
        $configuration->getTemplate(ResourceActions::CREATE . '.html')->willReturn('SyliusShopBundle:CRUD_DUMMY:create.html.twig');
        ...
        $expectedView = View::create()
            ...
            ->setTemplate('SyliusShopBundle:CRUD_DUMMY:create.html.twig')
        ;
    ...
    function it_returns_a_html_response_for_updating_resource_form(
        ...
        $configuration->isHtmlRequest()->willReturn(true);
        $configuration->getTemplate(ResourceActions::UPDATE . '.html')->willReturn('SyliusShopBundle:CRUD_DUMMY:update.html.twig');
        ...
        $expectedView = View::create()
            ...
            ->setTemplate('SyliusShopBundle:CRUD_DUMMY:update.html.twig')
        ;
    ...
    function it_applies_state_machine_transition_to_updated_resource_if_configured(
        ...
        $configuration->isHtmlRequest()->willReturn(true);
        $configuration->getTemplate(ResourceActions::UPDATE)->willReturn('SyliusShopBundle:CRUD_DUMMY:update.html.twig');
