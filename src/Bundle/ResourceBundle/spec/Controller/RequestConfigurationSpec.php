...
final class RequestConfigurationSpec extends ObjectBehavior
{
    ...
    {
        $metadata->getTemplatesNamespace()->willReturn('SyliusAdminBundle:CRUD_DUMMY');

        $this->getDefaultTemplate('index.html')->shouldReturn('SyliusAdminBundle:CRUD_DUMMY:index.html.twig');
        $this->getDefaultTemplate('show.html')->shouldReturn('SyliusAdminBundle:CRUD_DUMMY:show.html.twig');
        $this->getDefaultTemplate('create.html')->shouldReturn('SyliusAdminBundle:CRUD_DUMMY:create.html.twig');
        $this->getDefaultTemplate('update.html')->shouldReturn('SyliusAdminBundle:CRUD_DUMMY:update.html.twig');
        $this->getDefaultTemplate('custom.html')->shouldReturn('SyliusAdminBundle:CRUD_DUMMY:custom.html.twig');
    }
    ...
    {
        $metadata->getTemplatesNamespace()->willReturn('SyliusAdminBundle:CRUD_DUMMY');
        $parameters->get('template', 'SyliusAdminBundle:CRUD_DUMMY:foo.html.twig')->willReturn('AppBundle:CRUD_DUMMY:show.html.twig');

        $this->getTemplate('foo.html')->shouldReturn('AppBundle:CRUD_DUMMY:show.html.twig');
    }
