...
namespace Bundle\SessionBundle\Controller;

use FOS\RestBundle\View\View;
use Bundle\SessionBundle\Form\Type\SessionAttributeChoiceType;
...
class SessionAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(SessionAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
