...
use Bundle\VisitBundle\Form\Type\VisitAttributeChoiceType;
...
class VisitAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(VisitAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
