...
use Bundle\ProfileBundle\Form\Type\ProfileAttributeChoiceType;
...
class ProfileAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(ProfileAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
