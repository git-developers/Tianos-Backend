	...
	Chart.Scale = Chart.Element.extend({
		...
		calculateXLabelRotation : function(){
			...
			if (this.display){
				...
				var xOneToManyWidth = Math.floor(this.calculateX(1) - this.calculateX(0)) - 6;

				//Max label rotate should be 90 - also act as a loop counter
				while ((this.xLabelWidth > xOneToManyWidth && this.xLabelRotation === 0) || (this.xLabelWidth > xOneToManyWidth && this.xLabelRotation <= 90 && this.xLabelRotation > 0)){
		...
		calculateX : function(index){
			var isRotated = (this.xLabelRotation > 0),
				// innerWidth = (this.offsetOneToManyLines) ? this.width - offsetLeft - this.padding : this.width - (offsetLeft + halfLabelWidth * 2) - this.padding,
				innerWidth = this.width - (this.xScalePaddingLeft + this.xScalePaddingRight),
				valueWidth = innerWidth/Math.max((this.valuesCount - ((this.offsetOneToManyLines) ? 0 : 1)), 1),
				valueOffset = (valueWidth * index) + this.xScalePaddingLeft;

			if (this.offsetOneToManyLines){
			...
			if (this.display){
				...
				each(this.xLabels,function(label,index){
					var xPos = this.calculateX(index) + aliasPixel(this.lineWidth),
						...
						linePos = this.calculateX(index - (this.offsetOneToManyLines ? 0.5 : 0)) + aliasPixel(this.lineWidth),
...
(function(){
	...
	var defaultConfig = {
		...
		scaleShowOneToManyLines : true,

		//String - Colour of the grid lines
		scaleOneToManyLineColor : "rgba(0,0,0,.05)",

		//Number - Width of the grid lines
		scaleOneToManyLineWidth : 1,
	...
	Chart.Type.extend({
		...
		buildScale : function(labels){
			...
			var scaleOptions = {
				...
				gridLineWidth : (this.options.scaleShowOneToManyLines) ? this.options.scaleOneToManyLineWidth : 0,
				gridLineColor : (this.options.scaleShowOneToManyLines) ? this.options.scaleOneToManyLineColor : "rgba(0,0,0,0)",
	...
	Chart.Type.extend({
		...
		initialize:  function(data){
			...
			this.PointClass = Chart.Point.extend({
				offsetOneToManyLines : this.options.offsetOneToManyLines,
