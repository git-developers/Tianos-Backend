...
namespace spec\Bundle\TreeOneToManyBundle\Renderer;
...
final class TwigTreeOneToManyRendererSpec extends ObjectBehavior
{
    function let(
        ...
        $actionTemplates = [
            'link' => 'SyliusTreeOneToManyBundle:Action:_link.html.twig',
            'form' => 'SyliusTreeOneToManyBundle:Action:_form.html.twig',
        ];
        $filterTemplates = [
            StringFilter::NAME => 'SyliusTreeOneToManyBundle:Filter:_string.html.twig',
        ];
        ...
        $this->beConstructedWith(
            ...
            $formFactory,
            $formTypeRegistry,
            'SyliusTreeOneToManyBundle:default.html.twig',
            $actionTemplates,
            $filterTemplates
        );
    }
    ...
    {
        $twig->render('SyliusTreeOneToManyBundle:default.html.twig', ['grid' => $gridView])->willReturn('<html>OneToMany!</html>');
    ...
    {
        $twig->render('SyliusTreeOneToManyBundle:custom.html.twig', ['grid' => $gridView])->willReturn('<html>OneToMany!</html>');
        $this->render($gridView, 'SyliusTreeOneToManyBundle:custom.html.twig')->shouldReturn('<html>OneToMany!</html>');
    }
    ...
    function it_uses_twig_to_render_the_action(\Twig_Environment $twig, OneToManyViewInterface $gridView, Action $action): void
    {
        ...
        $twig
            ->render('SyliusTreeOneToManyBundle:Action:_link.html.twig', [
                'grid' => $gridView,
                'action' => $action,
                'data' => null,
            ])
