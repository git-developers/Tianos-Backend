...
namespace Bundle\UniversityBundle\Controller;

use FOS\RestBundle\View\View;
use Bundle\UniversityBundle\Form\Type\UniversityAttributeChoiceType;
...
class UniversityAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(UniversityAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
