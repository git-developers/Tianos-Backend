...
namespace Bundle\FacultadBundle\Controller;

use FOS\RestBundle\View\View;
use Bundle\FacultadBundle\Form\Type\FacultadAttributeChoiceType;
...
class FacultadAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(FacultadAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
