...
class CrudUserMapper extends Base
{
    ...
    const FORM_CHANGE_PASSWORD_NAME = 'form-change-password';
    ...
    const MODAL_CHANGE_PASSWORD_ID = 'modal-change-password';
    ...
    public function __construct(Router $router, RequestStack $requestStack)
    {
        ...
        $this->defaults = [
            ...
            'modal_change_password_id' => self::MODAL_CHANGE_PASSWORD_ID,
            'modal_change_password_size' => null,
            ...
            'form_change_password_name' => self::FORM_CHANGE_PASSWORD_NAME,
            'form_data' => [],
            'form_type' => null,
