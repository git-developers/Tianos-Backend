...
use Bundle\OrderinBundle\Controller\ProductAttributeController;
use Bundle\OrderinBundle\Doctrine\ORM\ProductAttributeValueRepository;
use Bundle\OrderinBundle\Form\Type\ProductAttributeTranslationType;
use Bundle\OrderinBundle\Form\Type\ProductAttributeType;
use Bundle\OrderinBundle\Form\Type\ProductAttributeValueType;
...
final class OrderinExtension extends AbstractResourceExtension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
