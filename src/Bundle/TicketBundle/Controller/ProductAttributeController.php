...
use Bundle\TicketBundle\Form\Type\TicketAttributeChoiceType;
...
class TicketAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(TicketAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
