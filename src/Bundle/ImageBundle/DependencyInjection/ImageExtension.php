...
namespace Bundle\ImageBundle\DependencyInjection;

use Bundle\ImageBundle\Controller\ProductAttributeController;
use Bundle\ImageBundle\Doctrine\ORM\ProductAttributeValueRepository;
use Bundle\ImageBundle\Form\Type\ProductAttributeTranslationType;
use Bundle\ImageBundle\Form\Type\ProductAttributeType;
use Bundle\ImageBundle\Form\Type\ProductAttributeValueType;
...
final class ImageExtension extends AbstractResourceExtension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
