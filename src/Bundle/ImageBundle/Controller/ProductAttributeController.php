...
namespace Bundle\ImageBundle\Controller;

use FOS\RestBundle\View\View;
use Bundle\ImageBundle\Form\Type\ImageAttributeChoiceType;
...
class ImageAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(ImageAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
