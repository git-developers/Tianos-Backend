...
namespace Bundle\ReportpointofsaleandproductBundle\EventListener;
...
use Bundle\ReportpointofsaleandproductBundle\Entity\Reportpointofsaleandproduct;
...
//        $className = $entityManager->getClassMetadata(get_class($entity))->getName();
        ...
        if ($entity instanceof Reportpointofsaleandproduct){
            $name = $entity->getName();
