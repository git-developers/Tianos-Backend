...
use Bundle\PdvhasproductBundle\Form\Type\PdvhasproductAttributeChoiceType;
...
class PdvhasproductAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(PdvhasproductAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
