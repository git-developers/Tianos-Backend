...
namespace Bundle\ModuleBundle\Controller;

use FOS\RestBundle\View\View;
use Bundle\ModuleBundle\Form\Type\ModuleAttributeChoiceType;
...
class ModuleAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(ModuleAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
