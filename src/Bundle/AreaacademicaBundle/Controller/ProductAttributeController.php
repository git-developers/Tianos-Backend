...
namespace Bundle\AreaacademicaBundle\Controller;

use FOS\RestBundle\View\View;
use Bundle\AreaacademicaBundle\Form\Type\AreaacademicaAttributeChoiceType;
...
class AreaacademicaAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(AreaacademicaAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
