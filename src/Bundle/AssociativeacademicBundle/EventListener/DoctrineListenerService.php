...
namespace Bundle\AssociativeacademicBundle\EventListener;
...
use Bundle\AssociativeacademicBundle\Entity\Associativeacademic;
...
//        $className = $entityManager->getClassMetadata(get_class($entity))->getName();
        ...
        if ($entity instanceof Associativeacademic){
            $name = $entity->getName();
