...
use Bundle\AssociativeacademicBundle\Form\Type\AssociativeacademicAttributeChoiceType;
...
class AssociativeacademicAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(AssociativeacademicAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
