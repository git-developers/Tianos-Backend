(function($) {
    ...
    $.boxThreeSearch = function(el, options) {
        ...
        base.$el = $(el);
        base.el = el;
        base.$el.data('boxThreeSearch', base);
    ...
    // $.boxThreeSearch.defaultOptions = {
    //     buttonStyle: "border: 1px solid #fff; background-color:#000; color:#fff; padding:20px 50px",
    //     buttonPress: function () {}
    // };

    $.fn.boxThreeSearch = function(options){

        return this.each(function(){

            var bp = new $.boxThreeSearch(this, options);

            $('div#' + options.boxThreeId + ' input[name=' + options.searchInputName + ']').keyup(function() {
                bp.searchBox(this);
            });
