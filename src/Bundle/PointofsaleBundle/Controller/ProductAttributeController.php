...
use Bundle\PointofsaleBundle\Form\Type\PointofsaleAttributeChoiceType;
...
class PointofsaleAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(PointofsaleAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
