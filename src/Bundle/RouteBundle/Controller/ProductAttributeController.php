...
namespace Bundle\RouteBundle\Controller;

use FOS\RestBundle\View\View;
use Bundle\RouteBundle\Form\Type\RouteAttributeChoiceType;
...
class RouteAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(RouteAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
