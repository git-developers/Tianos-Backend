...
namespace Bundle\OrderBundle\Controller;

use FOS\RestBundle\View\View;
use Bundle\OrderBundle\Form\Type\OrderinAttributeChoiceType;
...
class OrderinAttributeController extends ResourceController
{
    /**
    ...
    public function renderAttributesAction(Request $request): Response
    {
        ...
        $form = $this->get('form.factory')->create(OrderinAttributeChoiceType::class, null, [
            'multiple' => true,
        ]);
