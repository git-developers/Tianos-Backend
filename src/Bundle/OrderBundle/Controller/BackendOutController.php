...
class BackendOutController extends BaseController
{
...
//        $boxRight = json_decode(json_encode($boxRight));
        ...
        $orders = $this->get('tianos.repository.order')->findObjectCenterSelectItem(
            $pointOfSaleId,
            $userId,
            $orderDate,
            Order::OUT
...
//        $form->handleRequest($request);
        ...
        foreach ($quantities as $key => $quantity) {
            ...
            $order = $this->get('tianos.repository.order')->findObjectUpsert(
                $pointOfSaleId,
                $userId,
                $orderDate,
                $productId,
