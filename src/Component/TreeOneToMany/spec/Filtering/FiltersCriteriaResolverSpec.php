...
namespace spec\Component\TreeOneToMany\Filtering;

use PhpSpec\ObjectBehavior;
use Component\TreeOneToMany\Definition\Filter;
use Component\TreeOneToMany\Definition\TreeOneToMany;
use Component\TreeOneToMany\Filtering\FiltersCriteriaResolverInterface;
...
final class FiltersCriteriaResolverSpec extends ObjectBehavior
{
    ...
    function it_checks_whether_any_criteria_are_available(TreeOneToMany $grid, Filter $filter): void
    {
    ...
    function it_gets_default_criteria_from_grid_filters(TreeOneToMany $grid, Filter $firstFilter, Filter $secondFilter): void
    {
    ...
    function it_gets_criteria_from_parameters(TreeOneToMany $grid, Filter $firstFilter, Filter $secondFilter): void
    {
        $startDate = new \DateTime();
        $endDate = new \DateTime();
