...
final class FieldSpec extends ObjectBehavior
{
    ...
    {
        $this->setOptions(['template' => 'SyliusUiBundle:TreeOneToMany/Field:_status.html.twig']);
        $this->getOptions()->shouldReturn(['template' => 'SyliusUiBundle:TreeOneToMany/Field:_status.html.twig']);
    }
