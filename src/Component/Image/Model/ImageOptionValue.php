...
class ImageOptionValue implements ImageOptionValueInterface
{
    ...
    {
        /** @var ImageOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): ImageOptionValueTranslationInterface
    {
        return new ImageOptionValueTranslation();
    }
}
