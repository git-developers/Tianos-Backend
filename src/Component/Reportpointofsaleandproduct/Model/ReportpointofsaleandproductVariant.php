...
class ReportpointofsaleandproductVariant implements ReportpointofsaleandproductVariantInterface
{
     ...
     */
    protected $Reportpointofsaleandproduct;
    ...
    {
        $name = empty($this->getName()) ? $this->getReportpointofsaleandproduct()->getName() : $this->getName();
    ...
    {
        return $this->Reportpointofsaleandproduct;
    }
    ...
    {
        $this->Reportpointofsaleandproduct = $Reportpointofsaleandproduct;
    }
    ...
    {
        /** @var ReportpointofsaleandproductVariantTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): ReportpointofsaleandproductVariantTranslationInterface
    {
        return new ReportpointofsaleandproductVariantTranslation();
    }
}
