...
class VisitVariant implements VisitVariantInterface
{
    ...
    {
        $name = empty($this->getName()) ? $this->getVisit()->getName() : $this->getName();
    ...
    {
        /** @var VisitVariantTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): VisitVariantTranslationInterface
    {
        return new VisitVariantTranslation();
    }
}
