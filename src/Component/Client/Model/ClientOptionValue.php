...
class ClientOptionValue implements ClientOptionValueInterface
{
    ...
    {
        /** @var ClientOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): ClientOptionValueTranslationInterface
    {
        return new ClientOptionValueTranslation();
    }
}
