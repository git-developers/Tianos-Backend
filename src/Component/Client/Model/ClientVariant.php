...
class ClientVariant implements ClientVariantInterface
{
    ...
    {
        $name = empty($this->getName()) ? $this->getClient()->getName() : $this->getName();
    ...
    {
        /** @var ClientVariantTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): ClientVariantTranslationInterface
    {
        return new ClientVariantTranslation();
    }
}
