...
class GatoOptionValue implements GatoOptionValueInterface
{
    ...
    {
        /** @var GatoOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): GatoOptionValueTranslationInterface
    {
        return new GatoOptionValueTranslation();
    }
}
