...
class GatoVariant implements GatoVariantInterface
{
    ...
    {
        $name = empty($this->getName()) ? $this->getGato()->getName() : $this->getName();
    ...
    {
        /** @var GatoVariantTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): GatoVariantTranslationInterface
    {
        return new GatoVariantTranslation();
    }
}
