...
class FacultadVariant implements FacultadVariantInterface
{
    ...
    {
        $name = empty($this->getName()) ? $this->getFacultad()->getName() : $this->getName();
    ...
    {
        /** @var FacultadVariantTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): FacultadVariantTranslationInterface
    {
        return new FacultadVariantTranslation();
    }
}
