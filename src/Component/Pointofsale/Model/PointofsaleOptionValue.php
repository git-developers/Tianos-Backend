...
class PointofsaleOptionValue implements PointofsaleOptionValueInterface
{
    ...
    /**
     * @var PointofsaleOptionInterface
     */
    protected $option;
    ...
    {
        /** @var PointofsaleOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): PointofsaleOptionValueTranslationInterface
    {
        return new PointofsaleOptionValueTranslation();
    }
}
