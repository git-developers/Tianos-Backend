...
class AreaacademicaOptionValue implements AreaacademicaOptionValueInterface
{
    ...
    /**
     * @var AreaacademicaOptionInterface
     */
    protected $option;
    ...
    {
        /** @var AreaacademicaOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): AreaacademicaOptionValueTranslationInterface
    {
        return new AreaacademicaOptionValueTranslation();
    }
}
