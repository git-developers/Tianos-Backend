...
class BookingOptionValue implements BookingOptionValueInterface
{
    ...
    {
        /** @var BookingOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): BookingOptionValueTranslationInterface
    {
        return new BookingOptionValueTranslation();
    }
}
