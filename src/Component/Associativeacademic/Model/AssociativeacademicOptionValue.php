...
class AssociativeacademicOptionValue implements AssociativeacademicOptionValueInterface
{
    ...
    /**
     * @var AssociativeacademicOptionInterface
     */
    protected $option;
    ...
    {
        /** @var AssociativeacademicOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): AssociativeacademicOptionValueTranslationInterface
    {
        return new AssociativeacademicOptionValueTranslation();
    }
}
