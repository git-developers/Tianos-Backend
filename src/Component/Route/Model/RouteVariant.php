...
class RouteVariant implements RouteVariantInterface
{
    ...
    {
        $name = empty($this->getName()) ? $this->getRoute()->getName() : $this->getName();
    ...
    {
        /** @var RouteVariantTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): RouteVariantTranslationInterface
    {
        return new RouteVariantTranslation();
    }
}
