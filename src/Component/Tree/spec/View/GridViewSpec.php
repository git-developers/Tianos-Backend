...
final class TreeViewSpec extends ObjectBehavior
{
    function let(Tree $gridDefinition): void
    {
    ...
    {
        $this->shouldHaveType(TreeViewInterface::class);
    }
    ...
    function it_has_definition(Tree $gridDefinition): void
    {
    ...
    function it_knows_which_field_it_has_been_sorted_by(Tree $gridDefinition, Field $codeField, Field $nameField): void
    {
        $this->beConstructedWith(['foo', 'bar'], $gridDefinition, new Parameters([
    ...
    function it_throws_exception_when_trying_to_sort_by_a_non_existent_field(Tree $gridDefinition): void
    {
