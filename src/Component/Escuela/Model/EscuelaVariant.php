...
class EscuelaVariant implements EscuelaVariantInterface
{
    ...
    {
        $name = empty($this->getName()) ? $this->getEscuela()->getName() : $this->getName();
    ...
    {
        /** @var EscuelaVariantTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): EscuelaVariantTranslationInterface
    {
        return new EscuelaVariantTranslation();
    }
}
