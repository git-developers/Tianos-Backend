...
class SessionVariant implements SessionVariantInterface
{
    ...
    {
        $name = empty($this->getName()) ? $this->getSession()->getName() : $this->getName();
    ...
    {
        /** @var SessionVariantTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): SessionVariantTranslationInterface
    {
        return new SessionVariantTranslation();
    }
}
