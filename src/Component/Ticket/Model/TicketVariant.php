...
class TicketVariant implements TicketVariantInterface
{
    ...
    {
        $name = empty($this->getName()) ? $this->getTicket()->getName() : $this->getName();
    ...
    {
        /** @var TicketVariantTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): TicketVariantTranslationInterface
    {
        return new TicketVariantTranslation();
    }
}
