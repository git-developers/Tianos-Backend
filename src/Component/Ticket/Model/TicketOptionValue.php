...
class TicketOptionValue implements TicketOptionValueInterface
{
    ...
    {
        /** @var TicketOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): TicketOptionValueTranslationInterface
    {
        return new TicketOptionValueTranslation();
    }
}
