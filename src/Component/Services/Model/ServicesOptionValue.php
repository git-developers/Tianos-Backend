...
class ServicesOptionValue implements ServicesOptionValueInterface
{
    ...
    {
        /** @var ServicesOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): ServicesOptionValueTranslationInterface
    {
        return new ServicesOptionValueTranslation();
    }
}
