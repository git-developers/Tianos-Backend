...
class CategoryVariant implements CategoryVariantInterface
{
    ...
    {
        $name = empty($this->getName()) ? $this->getCategory()->getName() : $this->getName();
    ...
    {
        /** @var CategoryVariantTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): CategoryVariantTranslationInterface
    {
        return new CategoryVariantTranslation();
    }
}
