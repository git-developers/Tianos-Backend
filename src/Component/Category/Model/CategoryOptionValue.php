...
class CategoryOptionValue implements CategoryOptionValueInterface
{
    ...
    {
        /** @var CategoryOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): CategoryOptionValueTranslationInterface
    {
        return new CategoryOptionValueTranslation();
    }
}
