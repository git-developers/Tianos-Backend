...
class FilesOptionValue implements FilesOptionValueInterface
{
    ...
    {
        /** @var FilesOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): FilesOptionValueTranslationInterface
    {
        return new FilesOptionValueTranslation();
    }
}
