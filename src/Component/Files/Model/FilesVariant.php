...
class FilesVariant implements FilesVariantInterface
{
    ...
    {
        $name = empty($this->getName()) ? $this->getFiles()->getName() : $this->getName();
    ...
    {
        /** @var FilesVariantTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): FilesVariantTranslationInterface
    {
        return new FilesVariantTranslation();
    }
}
