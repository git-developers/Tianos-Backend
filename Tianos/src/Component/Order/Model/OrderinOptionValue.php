...
class OrderinOptionValue implements OrderinOptionValueInterface
{
    ...
    {
        /** @var OrderinOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): OrderinOptionValueTranslationInterface
    {
        return new OrderinOptionValueTranslation();
    }
}
