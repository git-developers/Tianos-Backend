...
class ModuleOptionValue implements ModuleOptionValueInterface
{
    ...
    {
        /** @var ModuleOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): ModuleOptionValueTranslationInterface
    {
        return new ModuleOptionValueTranslation();
    }
}
