...
namespace spec\Component\Tree\Definition;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Component\Tree\Definition\Action;
use Component\Tree\Definition\ActionGroup;
...
use Component\Tree\Event\TreeDefinitionConverterEvent;
...
final class ArrayToDefinitionConverterSpec extends ObjectBehavior
{
    ...
    {
        $grid = Tree::fromCodeAndDriverConfiguration(
        ...
        $eventDispatcher
            ->dispatch('sylius.grid.admin_tax_category', Argument::type(TreeDefinitionConverterEvent::class))
            ->shouldBeCalled()
        ;
