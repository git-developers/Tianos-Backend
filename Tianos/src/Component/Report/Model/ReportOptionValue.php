...
class ReportOptionValue implements ReportOptionValueInterface
{
    ...
    {
        /** @var ReportOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): ReportOptionValueTranslationInterface
    {
        return new ReportOptionValueTranslation();
    }
}
