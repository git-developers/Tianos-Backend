...
namespace spec\Component\TreeOneToMany\Definition;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Component\TreeOneToMany\Definition\Action;
use Component\TreeOneToMany\Definition\ActionGroup;
...
use Component\TreeOneToMany\Event\TreeOneToManyDefinitionConverterEvent;
...
final class ArrayToDefinitionConverterSpec extends ObjectBehavior
{
    ...
    {
        $grid = TreeOneToMany::fromCodeAndDriverConfiguration(
        ...
        $eventDispatcher
            ->dispatch('sylius.grid.admin_tax_category', Argument::type(TreeOneToManyDefinitionConverterEvent::class))
            ->shouldBeCalled()
        ;
