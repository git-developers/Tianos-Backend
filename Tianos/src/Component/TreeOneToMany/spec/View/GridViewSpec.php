...
final class TreeOneToManyViewSpec extends ObjectBehavior
{
    function let(TreeOneToMany $gridDefinition): void
    {
    ...
    {
        $this->shouldHaveType(TreeOneToManyViewInterface::class);
    }
    ...
    function it_has_definition(TreeOneToMany $gridDefinition): void
    {
    ...
    function it_knows_which_field_it_has_been_sorted_by(TreeOneToMany $gridDefinition, Field $codeField, Field $nameField): void
    {
        $this->beConstructedWith(['foo', 'bar'], $gridDefinition, new Parameters([
    ...
    function it_throws_exception_when_trying_to_sort_by_a_non_existent_field(TreeOneToMany $gridDefinition): void
    {
