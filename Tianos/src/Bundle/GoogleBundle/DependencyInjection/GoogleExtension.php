...
use Bundle\GoogleBundle\Controller\ProductAttributeController;
use Bundle\GoogleBundle\Doctrine\ORM\ProductAttributeValueRepository;
use Bundle\GoogleBundle\Form\Type\ProductAttributeTranslationType;
use Bundle\GoogleBundle\Form\Type\ProductAttributeType;
use Bundle\GoogleBundle\Form\Type\ProductAttributeValueType;
...
final class GoogleExtension extends AbstractResourceExtension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
