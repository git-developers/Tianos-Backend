 ...
 */
class Version20180601014012 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE pdv_has_product (id INT AUTO_INCREMENT NOT NULL, point_of_sale_id INT DEFAULT NULL, product_id INT DEFAULT NULL, user_id INT DEFAULT NULL, code VARCHAR(45) DEFAULT NULL, name VARCHAR(150) DEFAULT NULL, slug VARCHAR(150) DEFAULT NULL, uuid VARCHAR(50) NOT NULL, quantity INT NOT NULL, created_at DATETIME NOT NULL, user_create INT DEFAULT NULL, updated_at DATETIME DEFAULT NULL, user_update INT DEFAULT NULL, is_active TINYINT(1) DEFAULT \'1\', INDEX IDX_CF3C62C7A76ED395 (user_id), INDEX fk_pdv_has_product_product1_idx (product_id), INDEX fk_pdv_has_product_point_of_sale1_idx (point_of_sale_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pdv_has_product ADD CONSTRAINT FK_CF3C62C76B7E9A73 FOREIGN KEY (point_of_sale_id) REFERENCES point_of_sale (id)');
        $this->addSql('ALTER TABLE pdv_has_product ADD CONSTRAINT FK_CF3C62C74584665A FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('ALTER TABLE pdv_has_product ADD CONSTRAINT FK_CF3C62C7A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE pdv_has_product DROP FOREIGN KEY FK_CF3C62C7A76ED395');
        ...
        $this->addSql('ALTER TABLE pdv_has_product DROP FOREIGN KEY FK_CF3C62C74584665A');
        ...
        $this->addSql('ALTER TABLE pdv_has_product DROP FOREIGN KEY FK_CF3C62C76B7E9A73');
        ...
        $this->addSql('DROP TABLE pdv_has_product');
    }
}
